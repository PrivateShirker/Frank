<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Default.aspx.vb" Inherits="FranksTours._Default" %>
...
<%--    <script src="http://code.jquery.com/jquery-latest.js"></script>--%>
    ...
    <script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>    <link href="_Styles/BasicStyles.css" rel="stylesheet" />
    ...
    <div class="pageWrapper regBorder centerDiv">
        ...
        <section id="sectHome" class="mySects block width90 autoMarginLeftRight">
                    ...
                    <div class="centerDiv topMarginHalfem lightBlueBack">
                        <div class="lightBlueBack autoMarginLeftRight topMarginHalfem width60">
                            <div class="floatLeft aRight width50 lightBlueBack">
                                ...
                                <div id="peruChoices" class="displayNone lightBlueBack">
            ...
            <section class="centerDiv">
                <article id="mainMess" class="mySlides topMargin3em autoMargin width75">
                    ...
                    <div class="autoMargin bold regBorder topMargin1em whiteBack padding10 left">
                        ...
                        <p class="topMarginHalfem">
                            &nbsp;&nbsp;&nbsp;&nbsp;Remember, this site is still under construction so new information will be added over the next few months.
                ...
                <article id="slideShow1" class="mySlides whiteBack autoMargin padding5 width90 regBorder">
                    <div id="africaPhotos" class="whiteBack centerDiv width100" style="height:850px;">

                        <p class="pTitle topMargin1em" style="text-align:center">Africa</p>

                        <input id="africaPreviousBut" type="button" class="myBut autoMargin bottomMargin1em bold leftMargin4em floatLeft" style="font-size:1.5em;" 
                            value=" Previous Picture " />

                        <input id="pauseAfricaBut" type="button" class="myBut autoMargin bottomMargin1em bold leftMargin2em floatLeft" style="font-size:1.5em;" 
                            value=" Pause Slideshow " />

                        <input id="africaNextBut" type="button" class="myBut autoMargin bottomMargin1em bold leftMargin2em floatLeft" style="font-size:1.5em;" 
                            value=" Next Picture " />

                        <div class="clear"></div>

                        <img id="africaPic14" class="ssPic autoMargin regBorder" alt="Africa Pic14" src="_Images/Montage/Africa/Africa14.jpg" />
                        <img id="africaPic13" class="ssPic autoMargin regBorder" alt="Africa Pic13" src="_Images/Montage/Africa/Africa13.jpg" />
                        <img id="africaPic12" class="ssPic autoMargin regBorder" alt="Africa Pic12" src="_Images/Montage/Africa/Africa12.jpg" />
                        <img id="africaPic11" class="ssPic autoMargin regBorder" alt="Africa Pic11" src="_Images/Montage/Africa/Africa11.jpg" />
                        <img id="africaPic10" class="ssPic autoMargin regBorder" alt="Africa Pic10" src="_Images/Montage/Africa/Africa10.jpg" />
                        <img id="africaPic9" class="ssPic autoMargin regBorder" alt="Africa Pic9" src="_Images/Montage/Africa/Africa9.jpg" />
                        <img id="africaPic8" class="ssPic autoMargin regBorder" alt="Africa Pic8" src="_Images/Montage/Africa/Africa8.jpg" />
                        <img id="africaPic7" class="ssPic autoMargin regBorder" alt="Africa Pic7" src="_Images/Montage/Africa/Africa7.jpg" />
                        <img id="africaPic6" class="ssPic autoMargin regBorder" alt="Africa Pic6" src="_Images/Montage/Africa/Africa6.jpg" />
                        <img id="africaPic5" class="ssPic autoMargin regBorder" alt="Africa Pic5" src="_Images/Montage/Africa/Africa5.jpg" />
                        <img id="africaPic4" class="ssPic autoMargin regBorder" alt="Africa Pic4" src="_Images/Montage/Africa/Africa4.jpg" />
                        <img id="africaPic3" class="ssPic autoMargin regBorder" alt="Africa Pic3" src="_Images/Montage/Africa/Africa3.jpg" />
                        <img id="africaPic2" class="ssPic autoMargin regBorder" alt="Africa Pic2" src="_Images/Montage/Africa/Africa2.jpg" />
                        <img id="africaPic1" class="ssPic autoMargin regBorder" alt="Africa Pic1" src="_Images/Montage/Africa/Africa1.jpg" />
                    </div>
                ...
                <article id="slideShow2" class="mySlides whiteBack autoMargin width90">
                    <div id="icePhotos" class="whiteBack centerDiv padding10 regBorder" style="height:900px;">

                        <p class="pTitle topMargin1em bottomMargin1em" style="text-align:center">Iceland</p>

                        <input id="icePreviousBut" type="button" class="myBut autoMargin bottomMargin1em bold leftMargin4em floatLeft" 
                            style="font-size:1.5em;" value=" Previous Picture " />

                        <input id="pauseIceBut" type="button" class="myBut autoMargin bottomMargin1em bold leftMargin2em floatLeft" 
                            style="font-size:1.5em;" value=" Pause Slideshow " />

                        <input id="iceNextBut" type="button" class="myBut autoMargin bottomMargin1em bold leftMargin2em floatLeft" style="font-size:1.5em;" 
                            value=" Next Picture " />

                        <div class="clear"></div>

                        <img id="icePic18" class="ssPic autoMargin regBorder" alt="Ice Pic18" src="_Images/Montage/Iceland/IL18.jpg" />
                        <img id="icePic17" class="ssPic autoMargin regBorder" alt="Ice Pic17" src="_Images/Montage/Iceland/IL17.jpg" />
                        <img id="icePic16" class="ssPic autoMargin regBorder" alt="Ice Pic16" src="_Images/Montage/Iceland/IL16.jpg" />
                        <img id="icePic15" class="ssPic autoMargin regBorder" alt="Ice Pic15" src="_Images/Montage/Iceland/IL15.jpg" />
                        <img id="icePic14" class="ssPic autoMargin regBorder" alt="Ice Pic14" src="_Images/Montage/Iceland/IL14.jpg" />
                        <img id="icePic13" class="ssPic autoMargin regBorder" alt="Ice Pic13" src="_Images/Montage/Iceland/IL13.jpg" />
                        <img id="icePic12" class="ssPic autoMargin regBorder" alt="Ice Pic12" src="_Images/Montage/Iceland/IL12.jpg" />
                        <img id="icePic11" class="ssPic autoMargin regBorder" alt="Ice Pic11" src="_Images/Montage/Iceland/IL11.jpg" />
                        <img id="icePic10" class="ssPic autoMargin regBorder" alt="Ice Pic10" src="_Images/Montage/Iceland/IL10.jpg" />
                        <img id="icePic9" class="ssPic autoMargin regBorder" alt="Ice Pic9" src="_Images/Montage/Iceland/IL9.jpg" />
                        <img id="icePic8" class="ssPic autoMargin regBorder" alt="Ice Pic8" src="_Images/Montage/Iceland/IL8.jpg" />
                        <img id="icePic7" class="ssPic autoMargin regBorder" alt="Ice Pic7" src="_Images/Montage/Iceland/IL7.jpg" />
                        <img id="icePic6" class="ssPic autoMargin regBorder" alt="Ice Pic6" src="_Images/Montage/Iceland/IL6.jpg" />
                        <img id="icePic5" class="ssPic autoMargin regBorder" alt="Ice Pic5" src="_Images/Montage/Iceland/IL5.jpg" />
                        <img id="icePic4" class="ssPic autoMargin regBorder" alt="Ice Pic4" src="_Images/Montage/Iceland/IL4.jpg" />
                        <img id="icePic3" class="ssPic autoMargin regBorder" alt="Ice Pic3" src="_Images/Montage/Iceland/IL3.jpg" />
                        <img id="icePic2" class="ssPic autoMargin regBorder" alt="Ice Pic2" src="_Images/Montage/Iceland/IL2.jpg" />
                        <img id="icePic1" class="ssPic autoMargin regBorder" alt="Ice Pic1" src="_Images/Montage/Iceland/IL1.jpg" />
                    </div>
                ...
                <article id="slideShow3" class="mySlides whiteBack autoMargin width90">
                    <div id="turkPhotos" class="whiteBack centerDiv regBorder" style="height:900px;">

                        <p class="pTitle topMargin1em bottomMargin1em" style="text-align:center">Turkey</p>

                        <input id="turkPreviousBut" type="button" class="myBut autoMargin bottomMargin1em bold leftMargin4em floatLeft" 
                            style="font-size:1.5em;" value=" Previous Picture " />

                        <input id="pauseTurkBut" type="button" class="myBut autoMargin bottomMargin1em bold leftMargin2em floatLeft" 
                            style="font-size:1.5em;" value=" Pause Slideshow " />

                        <input id="turkNextBut" type="button" class="myBut autoMargin bottomMargin1em bold leftMargin2em floatLeft" style="font-size:1.5em;" 
                            value=" Next Picture " />

                        <div class="clear"></div>

                        <img id="turkPic23" class="ssPic autoMargin regBorder" alt="Turkey Pic23" src="_Images/Montage/Turkey/Turk23.jpg" />
                        <img id="turkPic22" class="ssPic autoMargin regBorder" alt="Turkey Pic22" src="_Images/Montage/Turkey/Turk22.jpg" />
                        <img id="turkPic21" class="ssPic autoMargin regBorder" alt="Turkey Pic21" src="_Images/Montage/Turkey/Turk21.jpg" />
                        <img id="turkPic20" class="ssPic autoMargin regBorder" alt="Turkey Pic20" src="_Images/Montage/Turkey/Turk20.jpg" />
                        <img id="turkPic19" class="ssPic autoMargin regBorder" alt="Turkey Pic19" src="_Images/Montage/Turkey/Turk19.jpg" />
                        <img id="turkPic18" class="ssPic autoMargin regBorder" alt="Turkey Pic18" src="_Images/Montage/Turkey/Turk18.jpg" />
                        <img id="turkPic17" class="ssPic autoMargin regBorder" alt="Turkey Pic17" src="_Images/Montage/Turkey/Turk17.jpg" />
                        <img id="turkPic16" class="ssPic autoMargin regBorder" alt="Turkey Pic16" src="_Images/Montage/Turkey/Turk16.jpg" />
                        <img id="turkPic15" class="ssPic autoMargin regBorder" alt="Turkey Pic15" src="_Images/Montage/Turkey/Turk15.jpg" />
                        <img id="turkPic14" class="ssPic autoMargin regBorder" alt="Turkey Pic14" src="_Images/Montage/Turkey/Turk14.jpg" />
                        <img id="turkPic13" class="ssPic autoMargin regBorder" alt="Turkey Pic13" src="_Images/Montage/Turkey/Turk13.jpg" />
                        <img id="turkPic12" class="ssPic autoMargin regBorder" alt="Turkey Pic12" src="_Images/Montage/Turkey/Turk12.jpg" />
                        <img id="turkPic11" class="ssPic autoMargin regBorder" alt="Turkey Pic11" src="_Images/Montage/Turkey/Turk11.jpg" />
                        <img id="turkPic10" class="ssPic autoMargin regBorder" alt="Turkey Pic10" src="_Images/Montage/Turkey/Turk10.jpg" />
                        <img id="turkPic9" class="ssPic autoMargin regBorder" alt="Turkey Pic9" src="_Images/Montage/Turkey/Turk9.jpg" />
                        <img id="turkPic8" class="ssPic autoMargin regBorder" alt="Turkey Pic8" src="_Images/Montage/Turkey/Turk8.jpg" />
                        <img id="turkPic7" class="ssPic autoMargin regBorder" alt="Turkey Pic7" src="_Images/Montage/Turkey/Turk7.jpg" />
                        <img id="turkPic6" class="ssPic autoMargin regBorder" alt="Turkey Pic6" src="_Images/Montage/Turkey/Turk6.jpg" />
                        <img id="turkPic5" class="ssPic autoMargin regBorder" alt="Turkey Pic5" src="_Images/Montage/Turkey/Turk5.jpg" />
                        <img id="turkPic4" class="ssPic autoMargin regBorder" alt="Turkey Pic4" src="_Images/Montage/Turkey/Turk4.jpg" />
                        <img id="turkPic3" class="ssPic autoMargin regBorder" alt="Turkey Pic3" src="_Images/Montage/Turkey/Turk3.jpg" />
                        <img id="turkPic2" class="ssPic autoMargin regBorder" alt="Turkey Pic2" src="_Images/Montage/Turkey/Turk2.jpg" />
                        <img id="turkPic1" class="ssPic autoMargin regBorder" alt="Turkey Pic1" src="_Images/Montage/Turkey/Turk1.jpg" />
                    </div>
                ...
                <article id="slideShow4" class="mySlides whiteBack autoMargin width90">
                    <div id="chinaPhotos" class="whiteBack centerDiv regBorder" style="height:900px;">

                        <p class="pTitle topMargin1em bottomMargin1em" style="text-align:center">China</p>

                        <input id="chinaPreviousBut" type="button" class="myBut autoMargin bottomMargin1em bold leftMargin4em floatLeft" 
                            style="font-size:1.5em;" value=" Previous Picture " />

                        <input id="pauseChinaBut" type="button" class="myBut autoMargin bottomMargin1em bold leftMargin2em floatLeft" 
                            style="font-size:1.5em;" value=" Pause Slideshow " />

                        <input id="chinaNextBut" type="button" class="myBut autoMargin bottomMargin1em bold leftMargin2em floatLeft" style="font-size:1.5em;" 
                            value=" Next Picture " />

                        <div class="clear"></div>

                        <img id="chinaPic27" class="ssPic autoMargin regBorder" alt="China Pic27" src="_Images/China/China27.jpg" />
                        <img id="chinaPic26" class="ssPic autoMargin regBorder" alt="China Pic26" src="_Images/China/China26.jpg" />
                        <img id="chinaPic25" class="ssPic autoMargin regBorder" alt="China Pic25" src="_Images/China/China25.jpg" />
                        <img id="chinaPic24" class="ssPic autoMargin regBorder" alt="China Pic24" src="_Images/China/China24.jpg" />
                        <img id="chinaPic23" class="ssPic autoMargin regBorder" alt="China Pic23" src="_Images/China/China23.jpg" />
                        <img id="chinaPic22" class="ssPic autoMargin regBorder" alt="China Pic22" src="_Images/China/China22.jpg" />
                        <img id="chinaPic21" class="ssPic autoMargin regBorder" alt="China Pic21" src="_Images/China/China21.jpg" />
                        <img id="chinaPic20" class="ssPic autoMargin regBorder" alt="China Pic20" src="_Images/China/China20.jpg" />
                        <img id="chinaPic19" class="ssPic autoMargin regBorder" alt="China Pic19" src="_Images/China/China19.jpg" />
                        <img id="chinaPic18" class="ssPic autoMargin regBorder" alt="China Pic18" src="_Images/China/China18.jpg" />
                        <img id="chinaPic17" class="ssPic autoMargin regBorder" alt="China Pic17" src="_Images/China/China17.jpg" />
                        <img id="chinaPic16" class="ssPic autoMargin regBorder" alt="China Pic16" src="_Images/China/China16.jpg" />
                        <img id="chinaPic15" class="ssPic autoMargin regBorder" alt="China Pic15" src="_Images/China/China15.jpg" />
                        <img id="chinaPic14" class="ssPic autoMargin regBorder" alt="China Pic14" src="_Images/China/China14.jpg" />
                        <img id="chinaPic13" class="ssPic autoMargin regBorder" alt="China Pic13" src="_Images/China/China13.jpg" />
                        <img id="chinaPic12" class="ssPic autoMargin regBorder" alt="China Pic12" src="_Images/China/China12.jpg" />
                        <img id="chinaPic11" class="ssPic autoMargin regBorder" alt="China Pic11" src="_Images/China/China11.jpg" />
                        <img id="chinaPic10" class="ssPic autoMargin regBorder" alt="China Pic10" src="_Images/China/China10.jpg" />
                        <img id="chinaPic9" class="ssPic autoMargin regBorder" alt="China Pic9" src="_Images/China/China9.jpg" />
                        <img id="chinaPic8" class="ssPic autoMargin regBorder" alt="China Pic8" src="_Images/China/China8.jpg" />
                        <img id="chinaPic7" class="ssPic autoMargin regBorder" alt="China Pic7" src="_Images/China/China7.jpg" />
                        <img id="chinaPic6" class="ssPic autoMargin regBorder" alt="China Pic6" src="_Images/China/China6.jpg" />
                        <img id="chinaPic5" class="ssPic autoMargin regBorder" alt="China Pic5" src="_Images/China/China5.jpg" />
                        <img id="chinaPic4" class="ssPic autoMargin regBorder" alt="China Pic4" src="_Images/China/China4.jpg" />
                        <img id="chinaPic3" class="ssPic autoMargin regBorder" alt="China Pic3" src="_Images/China/China3.jpg" />
                        <img id="chinaPic2" class="ssPic autoMargin regBorder" alt="China Pic2" src="_Images/China/China2.jpg" />
                        <img id="chinaPic1" class="ssPic autoMargin regBorder" alt="China Pic1" src="_Images/China/China1.jpg" />
                    </div>
                ...
                <article id="slideShow5" class="mySlides whiteBack autoMargin width90">
                    <div id="peruPhotos" class="whiteBack centerDiv regBorder" style="height:900px;">

                        <h1 id="peruTitle" class="myH1 centerText topMargin1em bottomMargin1em" style="font-size:2em;">People of Peru</h1>

                        <input id="peruPreviousBut" type="button" class="myBut autoMargin bottomMargin1em bold leftMargin4em floatLeft" 
                            style="font-size:1.5em;" value=" Previous Picture " />

                        <input id="pausePeruBut" type="button" class="myBut autoMargin bottomMargin1em bold leftMargin2em floatLeft" 
                            style="font-size:1.5em;" value=" Pause Slideshow " />

                        <input id="peruNextBut" type="button" class="myBut autoMargin bottomMargin1em bold leftMargin2em floatLeft" style="font-size:1.5em;" 
                            value=" Next Picture " />

                        <div class="clear"></div>

                        <img id="peruPic33" class="ssPic autoMargin regBorder" alt="Peru Pic33" src="_Images/Peru People/PeruPeople33.jpg" />
                        <img id="peruPic32" class="ssPic autoMargin regBorder" alt="Peru Pic32" src="_Images/Peru People/PeruPeople32.jpg" />
                        <img id="peruPic31" class="ssPic autoMargin regBorder" alt="Peru Pic31" src="_Images/Peru People/PeruPeople31.jpg" />
                        <img id="peruPic30" class="ssPic autoMargin regBorder" alt="Peru Pic30" src="_Images/Peru People/PeruPeople30.jpg" />
                        <img id="peruPic29" class="ssPic autoMargin regBorder" alt="Peru Pic29" src="_Images/Peru People/PeruPeople29.jpg" />
                        <img id="peruPic28" class="ssPic autoMargin regBorder" alt="Peru Pic28" src="_Images/Peru People/PeruPeople28.jpg" />
                        <img id="peruPic27" class="ssPic autoMargin regBorder" alt="Peru Pic27" src="_Images/Peru People/PeruPeople27.jpg" />
                        <img id="peruPic26" class="ssPic autoMargin regBorder" alt="Peru Pic26" src="_Images/Peru People/PeruPeople26.jpg" />
                        <img id="peruPic25" class="ssPic autoMargin regBorder" alt="Peru Pic25" src="_Images/Peru People/PeruPeople25.jpg" />
                        <img id="peruPic24" class="ssPic autoMargin regBorder" alt="Peru Pic24" src="_Images/Peru People/PeruPeople24.jpg" />
                        <img id="peruPic23" class="ssPic autoMargin regBorder" alt="Peru Pic23" src="_Images/Peru People/PeruPeople23.jpg" />
                        <img id="peruPic22" class="ssPic autoMargin regBorder" alt="Peru Pic22" src="_Images/Peru People/PeruPeople22.jpg" />
                        <img id="peruPic21" class="ssPic autoMargin regBorder" alt="Peru Pic21" src="_Images/Peru People/PeruPeople21.jpg" />
                        <img id="peruPic20" class="ssPic autoMargin regBorder" alt="Peru Pic20" src="_Images/Peru People/PeruPeople20.jpg" />
                        <img id="peruPic19" class="ssPic autoMargin regBorder" alt="Peru Pic19" src="_Images/Peru People/PeruPeople19.jpg" />
                        <img id="peruPic18" class="ssPic autoMargin regBorder" alt="Peru Pic18" src="_Images/Peru People/PeruPeople18.jpg" />
                        <img id="peruPic17" class="ssPic autoMargin regBorder" alt="Peru Pic17" src="_Images/Peru People/PeruPeople17.jpg" />
                        <img id="peruPic16" class="ssPic autoMargin regBorder" alt="Peru Pic16" src="_Images/Peru People/PeruPeople16.jpg" />
                        <img id="peruPic15" class="ssPic autoMargin regBorder" alt="Peru Pic15" src="_Images/Peru People/PeruPeople15.jpg" />
                        <img id="peruPic14" class="ssPic autoMargin regBorder" alt="Peru Pic14" src="_Images/Peru People/PeruPeople14.jpg" />
                        <img id="peruPic13" class="ssPic autoMargin regBorder" alt="Peru Pic13" src="_Images/Peru People/PeruPeople13.jpg" />
                        <img id="peruPic12" class="ssPic autoMargin regBorder" alt="Peru Pic12" src="_Images/Peru People/PeruPeople12.jpg" />
                        <img id="peruPic11" class="ssPic autoMargin regBorder" alt="Peru Pic11" src="_Images/Peru People/PeruPeople11.jpg" />
                        <img id="peruPic10" class="ssPic autoMargin regBorder" alt="Peru Pic10" src="_Images/Peru People/PeruPeople10.jpg" />
                        <img id="peruPic9" class="ssPic autoMargin regBorder" alt="Peru Pic9" src="_Images/Peru People/PeruPeople9.jpg" />
                        <img id="peruPic8" class="ssPic autoMargin regBorder" alt="Peru Pic8" src="_Images/Peru People/PeruPeople8.jpg" />
                        <img id="peruPic7" class="ssPic autoMargin regBorder" alt="Peru Pic7" src="_Images/Peru People/PeruPeople7.jpg" />
                        <img id="peruPic6" class="ssPic autoMargin regBorder" alt="Peru Pic6" src="_Images/Peru People/PeruPeople6.jpg" />
                        <img id="peruPic5" class="ssPic autoMargin regBorder" alt="Peru Pic5" src="_Images/Peru People/PeruPeople5.jpg" />
                        <img id="peruPic4" class="ssPic autoMargin regBorder" alt="Peru Pic4" src="_Images/Peru People/PeruPeople4.jpg" />
                        <img id="peruPic3" class="ssPic autoMargin regBorder" alt="Peru Pic3" src="_Images/Peru People/PeruPeople3.jpg" />
                        <img id="peruPic2" class="ssPic autoMargin regBorder" alt="Peru Pic2" src="_Images/Peru People/PeruPeople2.jpg" />
                        <img id="peruPic1" class="ssPic autoMargin regBorder" alt="Peru Pic1" src="_Images/Peru People/PeruPeople1.jpg" />
                    </div>
                ...
                <article id="slideShow6" class="mySlides whiteBack autoMargin width90">
                    <div id="machuPicchuPhotos" class="whiteBack centerDiv regBorder" style="height:900px;">

                        <h1 class="myH1 centerText topMargin1em bottomMargin1em" style="font-size:2em;">Machu Picchu and the Surrounding Area</h1>

                        <input id="machuPicchuPreviousBut" type="button" class="myBut autoMargin bottomMargin1em bold leftMargin4em floatLeft" 
                            style="font-size:1.5em;" value=" Previous Picture " />

                        <input id="pauseMachuPicchuBut" type="button" class="myBut autoMargin bottomMargin1em bold leftMargin2em floatLeft" 
                            style="font-size:1.5em;" value=" Pause Slideshow " />

                        <input id="machuPicchuNextBut" type="button" class="myBut autoMargin bottomMargin1em bold leftMargin2em floatLeft" style="font-size:1.5em;" 
                            value=" Next Picture " />

                        <div class="clear"></div>

                        <img id="MP40" class="ssPic autoMargin regBorder" alt="Peru Pic95" src="_Images/Machu Pichu/MP40.jpg" />
                        <img id="MP39" class="ssPic autoMargin regBorder" alt="Peru Pic72" src="_Images/Machu Pichu/MP39.jpg" />
                        <img id="MP38" class="ssPic autoMargin regBorder" alt="Peru Pic71" src="_Images/Machu Pichu/MP38.jpg" />
                        <img id="MP37" class="ssPic autoMargin regBorder" alt="Peru Pic70" src="_Images/Machu Pichu/MP37.jpg" />
                        <img id="MP36" class="ssPic autoMargin regBorder" alt="Peru Pic69" src="_Images/Machu Pichu/MP36.jpg" />
                        <img id="MP35" class="ssPic autoMargin regBorder" alt="Peru Pic68" src="_Images/Machu Pichu/MP35.jpg" />
                        <img id="MP34" class="ssPic autoMargin regBorder" alt="Peru Pic67" src="_Images/Machu Pichu/MP34.jpg" />
                        <img id="MP33" class="ssPic autoMargin regBorder" alt="Peru Pic66" src="_Images/Machu Pichu/MP33.jpg" />
                        <img id="MP32" class="ssPic autoMargin regBorder" alt="Peru Pic65" src="_Images/Machu Pichu/MP32.jpg" />
                        <img id="MP31" class="ssPic autoMargin regBorder" alt="Peru Pic64" src="_Images/Machu Pichu/MP31.jpg" />
                        <img id="MP30" class="ssPic autoMargin regBorder" alt="Peru Pic63" src="_Images/Machu Pichu/MP30.jpg" />
                        <img id="MP29" class="ssPic autoMargin regBorder" alt="Peru Pic62" src="_Images/Machu Pichu/MP29.jpg" />
                        <img id="MP28" class="ssPic autoMargin regBorder" alt="Peru Pic61" src="_Images/Machu Pichu/MP28.jpg" />
                        <img id="MP27" class="ssPic autoMargin regBorder" alt="Peru Pic60" src="_Images/Machu Pichu/MP27.jpg" />
                        <img id="MP26" class="ssPic autoMargin regBorder" alt="Peru Pic59" src="_Images/Machu Pichu/MP26.jpg" />
                        <img id="MP25" class="ssPic autoMargin regBorder" alt="Peru Pic58" src="_Images/Machu Pichu/MP25.jpg" />
                        <img id="MP24" class="ssPic autoMargin regBorder" alt="Peru Pic57" src="_Images/Machu Pichu/MP24.jpg" />
                        <img id="MP23" class="ssPic autoMargin regBorder" alt="Peru Pic56" src="_Images/Machu Pichu/MP23.jpg" />
                        <img id="MP22" class="ssPic autoMargin regBorder" alt="Peru Pic55" src="_Images/Machu Pichu/MP22.jpg" />
                        <img id="MP21" class="ssPic autoMargin regBorder" alt="Peru Pic54" src="_Images/Machu Pichu/MP21.jpg" />
                        <img id="MP20" class="ssPic autoMargin regBorder" alt="Peru Pic53" src="_Images/Machu Pichu/MP20.jpg" />
                        <img id="MP19" class="ssPic autoMargin regBorder" alt="Peru Pic52" src="_Images/Machu Pichu/MP19.jpg" />
                        <img id="MP18" class="ssPic autoMargin regBorder" alt="Peru Pic51" src="_Images/Machu Pichu/MP18.jpg" />
                        <img id="MP17" class="ssPic autoMargin regBorder" alt="Peru Pic50" src="_Images/Machu Pichu/MP17.jpg" />
                        <img id="MP16" class="ssPic autoMargin regBorder" alt="Peru Pic49" src="_Images/Machu Pichu/MP16.jpg" />
                        <img id="MP15" class="ssPic autoMargin regBorder" alt="Peru Pic48" src="_Images/Machu Pichu/MP15.jpg" />
                        <img id="MP14" class="ssPic autoMargin regBorder" alt="Peru Pic47" src="_Images/Machu Pichu/MP14.jpg" />
                        <img id="MP13" class="ssPic autoMargin regBorder" alt="Peru Pic46" src="_Images/Machu Pichu/MP13.jpg" />
                        <img id="MP12" class="ssPic autoMargin regBorder" alt="Peru Pic45" src="_Images/Machu Pichu/MP12.jpg" />
                        <img id="MP11" class="ssPic autoMargin regBorder" alt="Peru Pic44" src="_Images/Machu Pichu/MP11.jpg" />
                        <img id="MP10" class="ssPic autoMargin regBorder" alt="Peru Pic43" src="_Images/Machu Pichu/MP10.jpg" />
                        <img id="MP9" class="ssPic autoMargin regBorder" alt="Peru Pic42" src="_Images/Machu Pichu/MP9.jpg" />
                        <img id="MP8" class="ssPic autoMargin regBorder" alt="Peru Pic41" src="_Images/Machu Pichu/MP8.jpg" />
                        <img id="MP7" class="ssPic autoMargin regBorder" alt="Peru Pic40" src="_Images/Machu Pichu/MP7.jpg" />
                        <img id="MP6" class="ssPic autoMargin regBorder" alt="Peru Pic39" src="_Images/Machu Pichu/MP6.jpg" />
                        <img id="MP5" class="ssPic autoMargin regBorder" alt="Peru Pic38" src="_Images/Machu Pichu/MP5.jpg" />
                        <img id="MP4" class="ssPic autoMargin regBorder" alt="Peru Pic37" src="_Images/Machu Pichu/MP4.jpg" />
                        <img id="MP3" class="ssPic autoMargin regBorder" alt="Peru Pic36" src="_Images/Machu Pichu/MP3.jpg" />
                        <img id="MP2" class="ssPic autoMargin regBorder" alt="Peru Pic35" src="_Images/Machu Pichu/MP2.jpg" />
                        <img id="MP1" class="ssPic autoMargin regBorder" alt="Peru Pic34" src="_Images/Machu Pichu/MP1.jpg" />
                   </div>
                </article>

                <article id="slideShow7" class="mySlides whiteBack autoMargin width90">
                    <div id="peruFlowerPhotos" class="whiteBack centerDiv regBorder" style="height:900px;">

                        <h1 class="myH1 centerText topMargin1em bottomMargin1em" style="font-size:2em;">Flowers of Peru</h1>

                        <input id="peruFlowersPreviousBut" type="button" class="myBut autoMargin bottomMargin1em bold leftMargin4em floatLeft" 
                            style="font-size:1.5em;" value=" Previous Picture " />

                        <input id="pausePeruFlowersBut" type="button" class="myBut autoMargin bottomMargin1em bold leftMargin2em floatLeft" 
                            style="font-size:1.5em;" value=" Pause Slideshow " />

                        <input id="peruFlowersNextBut" type="button" class="myBut autoMargin bottomMargin1em bold leftMargin2em floatLeft" style="font-size:1.5em;" 
                            value=" Next Picture " />

                        <div class="clear"></div>

                        <img id="PF22" class="ssPic autoMargin regBorder" alt="Peru Pic94" src="_Images/Peru Flowers/PF22.jpg" />
                        <img id="PF21" class="ssPic autoMargin regBorder" alt="Peru Pic93" src="_Images/Peru Flowers/PF21.jpg" />
                        <img id="PF20" class="ssPic autoMargin regBorder" alt="Peru Pic92" src="_Images/Peru Flowers/PF20.jpg" />
                        <img id="PF19" class="ssPic autoMargin regBorder" alt="Peru Pic91" src="_Images/Peru Flowers/PF19.jpg" />
                        <img id="PF18" class="ssPic autoMargin regBorder" alt="Peru Pic90" src="_Images/Peru Flowers/PF18.jpg" />
                        <img id="PF17" class="ssPic autoMargin regBorder" alt="Peru Pic89" src="_Images/Peru Flowers/PF17.jpg" />
                        <img id="PF16" class="ssPic autoMargin regBorder" alt="Peru Pic88" src="_Images/Peru Flowers/PF16.jpg" />
                        <img id="PF15" class="ssPic autoMargin regBorder" alt="Peru Pic87" src="_Images/Peru Flowers/PF15.jpg" />
                        <img id="PF14" class="ssPic autoMargin regBorder" alt="Peru Pic86" src="_Images/Peru Flowers/PF14.jpg" />
                        <img id="PF13" class="ssPic autoMargin regBorder" alt="Peru Pic85" src="_Images/Peru Flowers/PF13.jpg" />
                        <img id="PF12" class="ssPic autoMargin regBorder" alt="Peru Pic84" src="_Images/Peru Flowers/PF12.jpg" />
                        <img id="PF11" class="ssPic autoMargin regBorder" alt="Peru Pic83" src="_Images/Peru Flowers/PF11.jpg" />
                        <img id="PF10" class="ssPic autoMargin regBorder" alt="Peru Pic82" src="_Images/Peru Flowers/PF10.jpg" />
                        <img id="PF9" class="ssPic autoMargin regBorder" alt="Peru Pic81" src="_Images/Peru Flowers/PF9.jpg" />
                        <img id="PF8" class="ssPic autoMargin regBorder" alt="Peru Pic80" src="_Images/Peru Flowers/PF8.jpg" />
                        <img id="PF7" class="ssPic autoMargin regBorder" alt="Peru Pic79" src="_Images/Peru Flowers/PF7.jpg" />
                        <img id="PF6" class="ssPic autoMargin regBorder" alt="Peru Pic78" src="_Images/Peru Flowers/PF6.jpg" />
                        <img id="PF5" class="ssPic autoMargin regBorder" alt="Peru Pic77" src="_Images/Peru Flowers/PF5.jpg" />
                        <img id="PF4" class="ssPic autoMargin regBorder" alt="Peru Pic76" src="_Images/Peru Flowers/PF4.jpg" />
                        <img id="PF3" class="ssPic autoMargin regBorder" alt="Peru Pic75" src="_Images/Peru Flowers/PF3.jpg" />
                        <img id="PF2" class="ssPic autoMargin regBorder" alt="Peru Pic74" src="_Images/Peru Flowers/PF2.jpg" />
                        <img id="PF1" class="ssPic autoMargin regBorder" alt="Peru Pic73" src="_Images/Peru Flowers/PF1.jpg" />
                    </div>
...
<%--                    <hr class="myHr" />--%>
        ...
        <section id="sectTurkey1" class="mySects noDisplay">
            <article class="padding10 bold left whiteBack topMargin1em centerDiv regBorder" style="margin-left:10px;margin-right:10px;">
                ...
                <div class="topMargin1em centerDiv left">
                    <div class="width80 autoMarginLeftRight">
                        <img class="regBorder floatLeft topMargin4em width45" alt="Thanksgiving.jpg" src="_Images/Turkey/Thanksgiving.jpg" />
                        <div class="floatLeft leftMargin2em width50">
                ...
                <div class="topMargin1em centerDiv left">
                    <div class="width80 autoMarginLeftRight">
                        <img class="regBorder floatLeft topMargin3em leftMargin2em width45" alt="Turkey1.jpg" src="_Images/Turkey/Turkey1.jpg" />
                        <img class="regBorder floatLeft topMargin2em leftMargin2em width45" alt="Turkey1.jpg" src="_Images/Turkey/Turkey2.jpg" />
                    </div>
                    <div class="clear"></div>
                    <div class="width80 padding5 autoMargin">
                        <p class="topMargin1em padding5 regBorder">
                ...
                <div class="topMargin1em left">
                    <img class="regBorder floatLeft topMargin1em width45" alt="Turkey3.jpg" src="_Images/Turkey/Turkey3.jpg" />
                    <div class="floatLeft leftMargin2em topMargin3em width50">
                ...
                <div class="topMargin1em centerDiv left">
                    <div class="width80 autoMarginLeftRight">
                        <img class="regBorder floatLeft topMargin5em leftMargin2em width45" alt="Turkey4.jpg" src="_Images/Turkey/Turkey4.jpg" />
                        <img class="regBorder floatLeft topMargin2em leftMargin2em width45" alt="Turkey5.jpg" src="_Images/Turkey/Turkey5.jpg" />
                    </div>
                ...
                <div class="topMargin1em centerDiv left">
                    <div class="floatLeft padding5 topMargin6em autoMarginLeftRight width45">
                        <p class="topMargin1em padding5 regBorder">
                    ...
                    <div class="floatLeft leftMargin3em width45">
                        <img class="regBorder topMargin2em width100" alt="Turkey6.jpg" src="_Images/Turkey/Turkey6.jpg" />
                        <img class="regBorder topMargin1em width100" alt="Turkey7.jpg" src="_Images/Turkey/Turkey7.jpg" />
                    </div>
                    <div class="clear"></div>
                </div>
                ...
                <div class="topMargin1em left">
                    <img class="regBorder floatLeft topMargin1em width50" alt="Turkey8.jpg" src="_Images/Turkey/Turkey8.jpg" />
                    <div class="floatLeft leftMargin2em width45">
                        <p class="topMargin2em padding5 regBorder">
                ...
                <div class="topMargin1em left">
                    ...
                    <img class="regBorder floatLeft leftMargin2em topMargin1em width50" alt="Turkey9.jpg" src="_Images/Turkey/Turkey9.jpg" />
                </div>
                ...
                <div class="centerDiv topMargin2em">
                    <div class="width80 autoMarginLeftRight left regBorder padding5">
                        <p>
        ...
        <section id="sectTurkey2" class="mySects noDisplay">
            <article class="padding10 bold whiteBack left topMargin1em centerDiv regBorder" style="margin-left:10px;margin-right:10px;">
                ...
                <div class="centerDiv">
                    <div class="topMargin1em autoMarginLeftRight width80 regBorder">
                        <p>
                ...
                <div class="topMargin1em">
                    <img class="regBorder floatLeft leftMargin2em width45 topMargin2em" alt="Turkey10.jpg" src="_Images/Turkey/Turkey10.jpg" />
                    <div class="floatLeft leftMargin2em width45">
                        <p class="topMargin3em padding5 regBorder whiteBack">
                ...
                <div class="topMargin1em left">
                    <div class="centerDiv">
                        <div class="autoMarginLeftRight width80">
                            <img class="regBorder floatLeft leftMargin2em topMargin2em width45" alt="Turkey14.jpg" src="_Images/Turkey/Turkey14.jpg" />
                            <img class="regBorder floatLeft leftMargin4em topMargin1em width45" alt="Turkey15.jpg" src="_Images/Turkey/Turkey15.jpg" />
                        </div>
                    </div>

                    <div class="clear"></div>
                    <div class="leftMargin2em whiteBack">
                        <img class="regBorder floatLeft topMargin2em width50" alt="Turkey16.jpg" src="_Images/Turkey/Turkey16.jpg" />
                        <div class="floatLeft whiteBack leftMargin1em width45">
                            <p class="topMargin1em padding5 regBorder">
                ...
                <div class="topMargin1em left">
                    <div class="centerDiv">
                        <div class="autoMarginLeftRight width80">
                            <img class="regBorder floatLeft leftMargin2em topMargin1em width45" alt="Turkey11.jpg" src="_Images/Turkey/Turkey11.jpg" />
                            <img class="regBorder floatLeft leftMargin4em topMargin1em width45" alt="Turkey12.jpg" src="_Images/Turkey/Turkey12.jpg" />
                        </div>
                    </div>
                    ...
                    <div class="leftMargin2em whiteBack">
                        <img class="regBorder floatLeft topMargin1em width25" alt="Turkey13.jpg" src="_Images/Turkey/Turkey13.jpg" />
                        <div class="floatLeft leftMargin4em width65">
                            <p class="topMargin1em padding5 regBorder">
                    ...
                    <div class="centerDiv">
                        <div class="autoMarginLeftRight width80">
                            <img class="regBorder floatLeft leftMargin2em topMargin1em width45" alt="Turkey17.jpg" src="_Images/Turkey/Turkey17.png" />
                            <img class="regBorder floatLeft leftMargin4em topMargin1em width45" alt="Turkey18.jpg" src="_Images/Turkey/Turkey18.jpg" />
                        </div>
                    </div>
                </div>
                ...
                <div class="topMargin1em left">
                    <div class="floatLeft width45">
                        <img class="regBorder leftMargin2em topMargin1em width100" alt="Turkey19.jpg" src="_Images/Turkey/Turkey19.jpg" />
                        <img class="regBorder leftMargin2em topMargin1em width100" alt="Turkey20.jpg" src="_Images/Turkey/Turkey20.jpg" />
                    </div>
                    <div class="leftMargin2em floatLeft width45">
                        <p class="topMargin10em padding5 regBorder">
                ...
                <div class="topMargin1em left">
                    <div class="centerDiv">
                        <img class="regBorder autoMarginLeftRight topMargin1em width70" alt="Turkey21.jpg" src="_Images/Turkey/Turkey21.jpg" />
                    </div>
                    <div class="clear"></div>
                    <div class="leftMargin2em topMargin10em floatLeft width45">
                        <p class="padding5 regBorder">
                    ...
                    <div class="leftMargin2em floatLeft width45">
                        <img class="regBorder leftMargin2em topMargin1em width100" alt="Turkey22.jpg" src="_Images/Turkey/Turkey22.jpg" />
                        <img class="regBorder leftMargin2em topMargin1em width100" alt="Turkey23.jpg" src="_Images/Turkey/Turkey23.jpg" />
                    </div>
                </div>
        ...
        <section id="sectTurkey3" class="mySects noDisplay">
            <article class="padding10 bold topMargin1em whiteBack centerDiv regBorder" style="margin-left:10px;margin-right:10px;">

                <div class="centerDiv whiteBack padding5">
                    <div class="autoMarginLeftRight regBorder padding10 showShadow" style="width:50%;">
                ...
                <div class="topMargin1em regBorder left">
                    ...
                    <div class="centerDiv">
                        <div class="width80 autoMarginLeftRight">
                            <img class="regBorder floatLeft leftMargin2em topMargin2em width45" alt="Turkey24.jpg" style="width:390px;" src="_Images/Turkey/Turkey24.jpg" />
                            <img class="regBorder floatLeft leftMargin2em topMargin2em width45" alt="Turkey25.jpg" style="width:390px;" src="_Images/Turkey/Turkey25.jpg" />
                        </div>
                    </div>
                    ...
                    <div>
                        <img class="regBorder floatLeft leftMargin2em topMargin2em width45" alt="Turkey26.jpg" src="_Images/Turkey/Turkey26.jpg" />
                        <div class="floatLeft padding5 leftMargin2em topMargin1em width45">
                            <p class="topMargin4em padding5 regBorder">
                    ...
                    <div class="clear centerDiv">
                        <img class="autoMarginLeftRight topMargin2em" alt="PageDivider.jpg" src="_Images/PageDivider.jpg" />
                    </div>

                    <div>
                        <div class="floatLeft topMargin10em width50">
                            <p class="padding5 regBorder">
                                We boated into
                        ...
                        <div class="floatLeft leftMargin2em width45">
                            <img class="regBorder topMargin2em width100" alt="Turkey27.jpg" style="width:390px;" src="_Images/Turkey/Turkey27.jpg" />
                            <img class="regBorder topMargin2em width100" alt="Turkey28.jpg" style="width:390px;" src="_Images/Turkey/Turkey28.jpg" />
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="centerDiv">
                            <div class="width70 autoMarginLeftRight">
                                <img class="floatLeft regBorder leftMargin2em topMargin2em width45" alt="Turkey29.jpg" src="_Images/Turkey/Turkey29.jpg" />
                                <img class="floatLeft regBorder leftMargin2em topMargin2em width45" alt="Turkey30.jpg" src="_Images/Turkey/Turkey30.jpg" />
                            </div>
                        </div>
                        ...
                        <div class="centerDiv">
                            <div class="autoMarginLeftRight topMargin2em width45">
                        ...
                        <div class="centerDiv">
                            <div class="topMargin2em autoMarginLeftRight width80">
                                <img class="regBorder floatLeft leftMargin2em topMargin2em width45" alt="Turkey31.jpg" src="_Images/Turkey/Turkey31.jpg" />
                                <img class="regBorder floatLeft leftMargin2em topMargin2em width45" alt="Turkey32.jpg" src="_Images/Turkey/Turkey32.jpg" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="centerDiv">
                            <div class="width70 autoMarginLeftRight">
                                <img class="floatLeft regBorder leftMargin2em topMargin2em width45" alt="Turkey33.jpg" src="_Images/Turkey/Turkey33.jpg" />
                                <img class="floatLeft regBorder leftMargin2em topMargin2em width45" alt="Turkey34.jpg" src="_Images/Turkey/Turkey34.jpg" />
                            </div>
                        </div>

                        <div class="clear"></div>

                        <div class="topMargin2em autoMargin width45">
                            <p class="padding5 regBorder">
                    ...
                    <div class="centerDiv">
                        <div class="width80 autoMarginLeftRight">
                            <img class="regBorder leftMargin2em topMargin2em width45" alt="Turkey35.jpg" src="_Images/Turkey/Turkey35.jpg" />
                            <img class="regBorder leftMargin2em topMargin2em width45" alt="Turkey36.jpg" src="_Images/Turkey/Turkey36.jpg" />
                        </div>
                    </div>
                    ...
                    <div class="floatLeft width50">
                        <img class="regBorder leftMargin2em topMargin2em width90" alt="Turkey37.jpg" src="_Images/Turkey/Turkey37.jpg" />
                    </div>
                    <div class=" floatLeft regBorder topMargin4em leftMargin2em width40">
                        <p class="padding5 ">
                    ...
                    <div>
                        <div class="centerDiv">
                            <div class="width80 autoMarginLeftRight">
                                <img class="regBorder leftMargin2em width45" alt="Turkey38.jpg" src="_Images/Turkey/Turkey38.jpg" />
                                <img class="regBorder leftMargin2em topMargin2em width45" alt="Turkey39.jpg" src="_Images/Turkey/Turkey39.jpg" />
                            </div>
                        </div>
                        ...
                        <div class="centerDiv topMargin1em">
                            <div class="floatLeft leftMargin1em width90">
                                <img class="regBorder topMargin2em leftMargin3em width30" alt="Turkey41.jpg" src="_Images/Turkey/Turkey41.jpg" />
                                <img class="regBorder topMargin2em leftMargin1em width30" alt="Turkey42.jpg" src="_Images/Turkey/Turkey42.jpg" />
                                <img class="regBorder topMargin2em leftMargin1em width30" alt="Turkey43.jpg" src="_Images/Turkey/Turkey43.jpg" />
                            </div>
                        </div>

                        <div class="centerDiv topMargin1em">
                            <div class="floatLeft leftMargin1em width90">
                                <img class="regBorder topMargin2em leftMargin3em width30" alt="Turkey44.jpg" src="_Images/Turkey/Turkey44.jpg" />
                                <img class="regBorder topMargin2em leftMargin1em width30" alt="Turkey45.jpg" src="_Images/Turkey/Turkey45.jpg" />
                                <img class="regBorder topMargin2em leftMargin1em width30" alt="Turkey46.jpg" src="_Images/Turkey/Turkey46.jpg" />
                            </div>
                        </div>

                        <div class="centerDiv topMargin1em">
                            <div class="floatLeft leftMargin1em width90">
                                <img class="regBorder topMargin2em leftMargin1em width30" alt="Turkey40.jpg" src="_Images/Turkey/Turkey40.jpg" />
                                <img class="regBorder topMargin2em leftMargin1em width65" alt="Turkey49.jpg" src="_Images/Turkey/Turkey49.jpg" />
                            </div>
                        </div>

                        <div class="centerDiv">
                            <div class="width90 autoMarginLeftRight">
                                <img class="regBorder topMargin2em autoMarginLeftRight width100" alt="Turkey48.jpg" src="_Images/Turkey/Turkey48.jpg" />
                            </div>
                        </div>
            ...
            <article class="padding10 bold left topMargin1em lightBlueBack centerDiv regBorder" style="margin-left:10px;margin-right:10px;">
                <div class="centerDiv lightBlueBack padding5">
                    ...
                    <div class="autoMargin regBorder padding10 showShadow" style="width:95%;">
                        ...
                        <p class="padding10 regBorder autoMarginLeftRight aLeft topMargin1em">
                             <img alt="River3.jpeg" class="floatRight showShadow topMargin1em bottomMargin1em leftMargin1em rightMargin1em width40"  src="_Images/RiverCruise/River3.jpg"/>
                            ...
                            adventures that were to come. Amsterdam, a canal city in itself, is alive with history, unparalleled architecture 
                        ...
                        <p class="padding10 regBorder aLeft">
                            ...
                            <img alt="River4.jpeg" class="floatLeft showShadow topMargin1em bottomMargin1em leftMargin1em rightMargin1em width40" src="_Images/RiverCruise/River4.jpg" /> let me 
                        ...
                        <p class="padding10 regBorder aLeft">
                            <img alt="River5.jpeg" src="_Images/RiverCruise/River5.jpg" class="floatRight showShadow topMargin1em bottomMargin1em leftMargin1em rightMargin1em width50" />
